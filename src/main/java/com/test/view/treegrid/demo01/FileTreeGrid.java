package com.test.view.treegrid.demo01;
...
/***
 * Show files and folders recursively in a TreeGrid<br>
 * Learn how to display file system folders easily using a Vaadin TreeGrid.<br>
 * 
...
public class FileTreeGrid extends VerticalLayout {
	...
	/*
	 * This static code block only sets up some artificial file tree, for users to
	 * browse.<br> Normally, you would likely want to expose some existing directory
	 * tree.
	 */
	static {
		try {
